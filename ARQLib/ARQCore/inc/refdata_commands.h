...
/// Represents a request to deactivate (soft-delete) a Reference Data record
template<c_RefData T>
struct Deactivate
{
...
ARQ_REG_TYPE( ARQ::RD::Cmd::Upsert<ARQ::RD::Currency> );
ARQ_REG_TYPE( ARQ::RD::Cmd::Deactivate<ARQ::RD::Currency> );
ARQ_REG_TYPE( ARQ::RD::Cmd::Upsert<ARQ::RD::User> );
ARQ_REG_TYPE( ARQ::RD::Cmd::Deactivate<ARQ::RD::User> );
