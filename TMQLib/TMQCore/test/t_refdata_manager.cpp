...
TEST_F( RefDataManagerTests, InsertStaleRecordThrowsWithCacheCheck )
{
    ...
    EXPECT_THROW( manager->insertCurrency( staleCcy ), TMQException );
...
TEST_F( RefDataManagerTests, InsertWithDbStaleCheckForcesReload )
{
    ...
    EXPECT_THROW( manager->insertCurrency( itemToInsert, RefDataManager::StaleCheck::USING_DB ), TMQException );
